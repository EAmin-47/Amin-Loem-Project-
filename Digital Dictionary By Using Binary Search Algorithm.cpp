...
{
	system("color B6"); // you can also change the color by adding b6 instead of 07
	char x = 175;
	char y = 174;
	char z = 240;
...
void history()
{
	...
	char hist[20];
	int X = 1;
	ifstream file("history.txt", ios::out); //This KEYWORD use for reprsenting the OUTPUT file and opening a file for writing
...
int main() {
	...
	cover();
	system("color 71");
	ofstream file("history.txt", ios::trunc);//This KEYWORD represents the output file stream and is used to 
